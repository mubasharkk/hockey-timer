                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Company Information */}
                                <div>
                                    <h2 className="text-lg font-semibold text-green-700 mb-3">Company Information</h2>
                                    <div className="space-y-2 text-gray-700">
                                        <p className="font-medium">MK IT Consulting</p>
                                        <p>Berlin, Germany</p>
                                        <p>
                                            <span className="font-medium">Website:</span>{' '}
                                            <a href="https://social-gizmo.com" className="text-green-700 hover:text-green-600 underline" target="_blank" rel="noopener noreferrer">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1 text-gray-700">
                                        <p>
                                            ...
                                            <a href="mailto:contact@social-gizmo.com" className="text-green-700 hover:text-green-600 underline">
                                ...
                                {/* VAT */}
                                <div>
                                    <h2 className="text-lg font-semibold text-green-700 mb-3">VAT Identification</h2>
                                    <p className="text-gray-700">DE368760166</p>
                                    <p className="text-xs text-gray-500 mt-1">VAT ID according to §27a German VAT Act</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                            ...
                            <p className="text-gray-700 mb-4">
                                We are proud to be the <span className="font-semibold">technical partner</span> for this platform, developed in collaboration with:
                            </p>
                            <div className="flex flex-wrap items-center justify-center gap-8">
                                <a href="https://aavasports.com/" target="_blank" rel="noopener noreferrer" className="transition hover:opacity-80">
                                    <img
                            ...
                            <p className="text-sm text-gray-500 mt-4 text-center">
                                This platform powers hockey tournaments and events for Aavaa Sports and the Karachi Hockey Association.
                            </p>
                        </div>
                            ...
                            <div className="space-y-4 text-gray-600">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm">
                                        ...
                                        of copyright law shall require the prior written consent of the respective author.
                                    </p>
                                </div>
                            </div>
                        </div>
